 ...
 * libitb3_c.a — this shim never calls libitb3.so directly.
 *
...
/* {error, {StatusAtom, DetailBinary}} where Detail is the libitb3
...
/* Binding-side error with a fixed message (no libitb3 call failed). */
 ...
 * The file is read inside libitb3. */
