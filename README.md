...
```erlang
{ok, Blob2} = itb:rekey(Sender, binary:copy(<<16#11>>, 32), binary:copy(<<16#22>>, 32)),
...
primitive names — is enforced by libitb; a duplicate name returns
